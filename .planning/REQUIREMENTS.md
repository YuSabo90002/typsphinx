...
### Rendering fidelity backlog (medium/low)

- Medium/low-severity rendering-fidelity issues found during the Phase 17 audit (F1, F2, F3, F5, F6, F7, F8, F9, F10, F11, F13, F14, F15) are fully recorded in `.planning/phases/17-rendering-fidelity-audit/17-AUDIT-CATALOGUE.md` as next-milestone candidates (D-11) — not enumerated here as individual requirements.
