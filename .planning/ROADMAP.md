...
- [x] 34-02-PLAN.md — separator-protocol fix in `visit_math` (3 protocols) and `visit_math_block` (list-item half), gate turned GREEN on both paths

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 34-03-PLAN.md — regression sweep: full suite vs. pre-fix baseline, lint/type, full-corpus `-b typstpdf` gate, docs dogfooding build, milestone invariants
...
- [x] 35-04-PLAN.md — SC#2 curated `## [0.6.5]` CHANGELOG entry (lead + `### Fixed` + `### Verified` per D-01–D-04) and the tail link-block rollover
