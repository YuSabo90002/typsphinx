...
- [x] **Phase 52: v0.8.0 Release Prep (prep-only)** - The v0.8.0 tree is bumped, its CHANGELOG curated around the output-shape change and the target-as-path reversal, proven green on real multi-master evidence, and handed off with no irreversible action taken (completed 2026-08-15)
...
- [x] 52-09-PLAN.md — Close the last CI defect test-side (CPython 3.13 `ntpath.isabs` drops driveless-absolute Windows paths), file the product-side inconsistency as a todo, and prove the third CI run fully green (SC#3, toolchain half — added mid-phase after 52-08 reached 11/12)
...
| 52. v0.8.0 Release Prep (prep-only) | v0.8.0 | 9/9 | Complete    | 2026-08-15 |
