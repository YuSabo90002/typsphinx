...
- [ ] v0.5.0 released to PyPI (REL-01) — Phase 10 adds the `__version__` 0.4.3→0.5.0 fix to PR #112, re-triggers the checks green, merges → tags `v*` → `release.yml` publishes. **CI-green observation already done in Phase 9** (PR #112, 13/13 jobs green, unmerged).
