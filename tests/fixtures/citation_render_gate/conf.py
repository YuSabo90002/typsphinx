...
# "second" (the toctree-included docname) has no typst_documents entry
# and keeps its unconditional content file, second.typ, unaffected.
typst_documents = [
    ("index", "master.typ", "Citation Render Gate", "Test Author"),
]
