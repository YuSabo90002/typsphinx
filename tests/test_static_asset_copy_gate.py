...
class TestStaticAssetCopyRenderGate:
    ...
    def test_typstpdf_copies_static_asset_and_produces_pdf(
        ...
        # have compiled to a real, non-empty PDF. Phase 47 (R4): the PDF is
        # the WRAPPER's own output ("master.pdf", this fixture's
        # typst_documents target after de-collision) -- only wrappers
        # compile to PDF.
